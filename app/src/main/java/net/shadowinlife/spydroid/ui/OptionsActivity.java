...
import static net.shadowinlife.http.TinyHttpServer.KEY_HTTPS_ENABLED;
import static net.shadowinlife.http.TinyHttpServer.KEY_HTTPS_PORT;
import static net.shadowinlife.http.TinyHttpServer.KEY_HTTP_ENABLED;
import static net.shadowinlife.http.TinyHttpServer.KEY_HTTP_PORT;
...
public class OptionsActivity extends PreferenceActivity {
	...
	private LivecastApplication mApplication = null;
