...
public class LivecastActivity extends FragmentActivity {

	static final public String TAG = "LivecastActivity";
	...
	private LivecastApplication mApplication;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mApplication = (LivecastApplication) getApplication();
		...
		mWakeLock = pm.newWakeLock(PowerManager.FULL_WAKE_LOCK, "net.shadowinlife.spydroid.wakelock");
	...
	public void onStart() {
		...
		if (mApplication.notificationEnabled) {
			Intent notificationIntent = new Intent(this, LivecastActivity.class);
	...
	public void onDestroy() {
		Log.d(TAG,"LivecastActivity destroyed");
		super.onDestroy();
	}
	...
	private RtspServer.CallbackListener mRtspCallbackListener = new RtspServer.CallbackListener() {
		...
		public void onError(RtspServer server, Exception e, int error) {
			...
			if (error == RtspServer.ERROR_BIND_FAILED) {
				new AlertDialog.Builder(LivecastActivity.this)
				.setTitle(R.string.port_used)
				.setMessage(getString(R.string.bind_failed, "RTSP"))
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					public void onClick(final DialogInterface dialog, final int id) {
						startActivityForResult(new Intent(LivecastActivity.this, OptionsActivity.class),0);
					}
				})
				.show();
			}
