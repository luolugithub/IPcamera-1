...
package net.shadowinlife.streaming;
...
import net.shadowinlife.streaming.audio.AudioStream;
import net.shadowinlife.streaming.exceptions.CameraInUseException;
import net.shadowinlife.streaming.exceptions.ConfNotSupportedException;
import net.shadowinlife.streaming.exceptions.InvalidSurfaceException;
import net.shadowinlife.streaming.exceptions.StorageUnavailableException;
import net.shadowinlife.streaming.gl.SurfaceView;
import net.shadowinlife.streaming.rtsp.RtspClient;
import net.shadowinlife.streaming.video.VideoQuality;
import net.shadowinlife.streaming.video.VideoStream;
...
public class Session {
	...
	static {
		...
		new HandlerThread("net.shadowinlife.streaming.Session"){
			@Override
