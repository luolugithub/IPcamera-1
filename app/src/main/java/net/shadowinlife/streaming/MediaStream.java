...
import net.shadowinlife.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(net.shadowinlife.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(net.shadowinlife.streaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link net.shadowinlife.streaming.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		final String LOCAL_ADDR = "net.shadowinlife.streaming-";
