...
package net.shadowinlife.streaming.rtsp;

import static net.shadowinlife.streaming.SessionBuilder.AUDIO_AAC;
import static net.shadowinlife.streaming.SessionBuilder.AUDIO_AMRNB;
import static net.shadowinlife.streaming.SessionBuilder.AUDIO_NONE;
import static net.shadowinlife.streaming.SessionBuilder.VIDEO_H263;
import static net.shadowinlife.streaming.SessionBuilder.VIDEO_H264;
import static net.shadowinlife.streaming.SessionBuilder.VIDEO_NONE;
...
import net.shadowinlife.streaming.MediaStream;
import net.shadowinlife.streaming.Session;
import net.shadowinlife.streaming.SessionBuilder;
import net.shadowinlife.streaming.audio.AudioQuality;
